...
<body>
    ...
    <div class="breadcrumb-area jarallax" style="background-image:url({{ asset('img/bg/3.jpg') }})">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="tp-gallery-item col-lg-3 col-sm-6">
                        <div class="single-destinations-list style-two">
                            <div class="tp-gallery-item-img">
                                <a href="{{ url('deals-details', $deal['id']) }}" data-effect="mfp-zoom-in">
                                    <img src="{{ asset( 'storage/' . $deal['image']) }}" alt="{{ $deal['place'] }}">
                                </a>
                            </div>
                            <div class="details">
                                <p class="location">CROSS BORDER</p>
                                <h4 class="title"><a href="{{ url('deals-details', $deal['id']) }}">{{ $deal['place'] }}</a></h4>
                                <p class="content">{{ $deal['package'] }}</p>
