                    ...
                    <div class="tp-gallery-item col-lg-3 col-sm-6">
                        <div class="single-destinations-list text-center">
                            <div class="thumb">
                                ...
                                <img src="{{ asset('storage/' . $india['image']) }}" alt="{{ $india['place'] }}">
                                <div class="d-list-btn-wrap">
                                    <div class="d-list-btn">
                                        <a class="btn btn-yellow" href="{{ url('incredibleindia-details', $india['id']) }}" tabindex="0">Know More
                                            <i class="fa fa-paper-plane"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="details">
                                <h5 class="title"><a href="{{ url('incredibleindia-details', $india['id']) }}">{{ $india['place'] }}</a></h5>

                                <ul class="tp-list-meta border-bt-dot">

                                    <li><i class="fa fa-clock-o"></i>{{ $india['package'] }}</li>
