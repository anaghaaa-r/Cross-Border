...
@if ($packages)
    ...
    <div class="breadcrumb-area jarallax" style="background-image:url({{ asset('img/bg/4.jpg') }})">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-4">
                                        <div class="tp-gallery-item-img">
                                            <a class="popup-thumb" href="{{ asset( 'storage/' . $packages['image']) }}" data-effect="mfp-zoom-in">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="tp-gallery-item col-lg-3 col-sm-6">
                    <div class="single-destinations-list style-two">
                        <div class="tp-gallery-item-img">
                            <a href="{{ url('deals-details', $alldeal['id']) }}" data-effect="mfp-zoom-in">
                                <img src="{{ asset('storage/' . $alldeal['image']) }}" alt="image">
                            </a>
                        </div>
                        <div class="details">
                            <p class="location">CROSS BORDER</p>
                            <h4 class="title"><a href="{{ url('deals-details', $alldeal['id']) }}">{{ $alldeal['place'] }}</a></h4>
                            <p class="content">{{ $alldeal['package'] }}</p>
                            <a class="btn-read-more" href="{{ url('deals-details', $alldeal['id']) }}"><span>Explore<i
