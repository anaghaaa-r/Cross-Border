...
<body>
    ...
    <div class="breadcrumb-area jarallax" style="background-image:url({{ asset('img/bg/1.png') }});">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-5 align-self-center">
                    <div class="section-title mb-lg-0">
                        <h2 class="title">HELPING YOU MAKE MEMORIES</h2>
                        <p>We are a professionally managed TMC (Travel Management Company) based in Dubai since 2006,
                            with a clear focus on bringing you a complete & cost effective travel, events and holiday
                            solutions with very high customer service standards. We assure you of total reliability and
                            professionalism of the highest order brought to you by a team of industry experienced
                            professionals.</p>
                ...
                <div class="col-lg-5 offset-lg-2">
                    <div class="thumb about-section-right-thumb">
                        <img src="{{ asset('img/others/9.png') }}" alt="img">
                        <img class="about-absolute-thumb" src="{{ asset('img/others/10.png') }}" alt="img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- video area start -->
    <div class="video-area tp-video-area pd-top-110 pd-bottom-70" style="background-image: url({{ asset('img/bg/7.png') }});">
        <div class="container">
            <div class="row">
