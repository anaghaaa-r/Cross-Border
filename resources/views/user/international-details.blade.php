...
@if ($packages)
    ...
    <div class="holiday-plan-area tp-holiday-plan-area mt-5" style="background-image: url({{ asset('img/bg/8.png') }});">
        <div class="container">
            ...
            @foreach ($allinternational as $allinternational)
                ...
                <div class="tp-gallery-item col-lg-3 col-sm-6">
                    <div class="single-destinations-list text-center">
                        <div class="thumb">
                            ...
                            <img src="{{ asset('storage/' . $allinternational['image']) }}" alt="list">
                            <div class="d-list-btn-wrap">
                                <div class="d-list-btn">
                                    <a class="btn btn-yellow" href="{{ url('international-details', $allinternational['id']) }}" tabindex="0">Know More
                                        <i class="fa fa-paper-plane"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="details">
                            <h5 class="title"><a href="{{ url('international-details', $allinternational['id']) }}">{{ $allinternational['place'] }}</a></h5>

                            <ul class="tp-list-meta border-bt-dot">

                                <li><i class="fa fa-clock-o"></i>{{ $allinternational['package'] }}</li>

                            </ul>
                            <div class="tp-price-meta tp-price-meta-cl">
                                <p>Price Starting from</p>
                                <h2>{{ $allinternational['price'] }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
