    ...
    <nav class="navbar navbar-area navbar-expand-lg nav-style-01">
        <div class="container nav-container">
            ...
            <div class="nav-right-content">
                <ul>
                    <li class="notification">
                        <button class="btn btn-yellow signUp-btn" id="showPopupBtn">Book Now <i class="fa fa-paper-plane"></i></button>
                    </li>
...
@if ($packages)
    ...
    <div class="breadcrumb-area jarallax" style="background-image:url({{ asset('img/bg/6.jpg') }})">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <!-- tour list area End -->
    <div class="gallery-area pd-top-50">
        <div class="container">
            <div class="gallery-filter-area row">
                ...
                <div class="row justify-content-center">
                    <div class="tp-gallery-item col-lg-12 col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-4">
                                        <div class="tp-gallery-item-img">
                                            <a class="popup-thumb" href="{{ asset('storage/' . $packages['image']) }}"
                                                data-effect="mfp-zoom-in">
                                                <img src="{{ asset('storage/' . $packages['image']) }}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-8 col-sm-8">
                                        <div class="details">
                                            <h2 class="title mb-3">{{ $packages['place'] }}</h2>

                                            <h4 class="title">Starting from {{ $packages['price'] }}</h4>

                                            <p class="content">{{ $packages['package'] }}</p>
                                            <p class="location"><i class="fa fa-calendar-o"></i> Valid till 30 Oct, 2021
                                            </p>

                                            <h5 class="title"><i class="fa fa-envelope-o"></i> <a
                                                    href="mailto:travel@cbts.in" target="_blank">travel@cbts.in</a></h5>

                                            <!-- <a class="btn btn-yellow mt-3" href="#"><span>Read More<i class="la la-arrow-right"></i></span></a>-->
    ...
    <div class="holiday-plan-area tp-holiday-plan-area mt-5" style="background-image: url({{ asset('img/bg/8.png') }});">
        <div class="container">
            <div class="row justify-content-center">
            ...
            @foreach ($allindia as $allindia)

                <div class="tp-gallery-item col-lg-3 col-sm-6">
                    <div class="single-destinations-list text-center">
                        <div class="thumb">
                            <span class="d-list-tag">Incredible India</span>
                            <img src="{{ asset('storage/' . $allindia['image']) }}" alt="list">
                            <div class="d-list-btn-wrap">
                                <div class="d-list-btn">
                                    <a class="btn btn-yellow" href="{{ url('incredibleindia-details', $allindia['id']) }}" tabindex="0">Know More <i
                                            class="fa fa-paper-plane"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="details">
                            <h5 class="title"><a href="{{ url('incredibleindia-details', $allindia['id']) }}">{{ $allindia['place'] }}</a></h5>

                            <ul class="tp-list-meta border-bt-dot">

                                <li><i class="fa fa-clock-o"></i>{{ $allindia['package'] }}</li>

                            </ul>
                            <div class="tp-price-meta tp-price-meta-cl">
                                <p>Price Starting from</p>
                                <h2>{{ $allindia['price'] }}</h2>
                                <!-- <del>₹ 6200</del> -->
                            </div>
                        </div>
                    </div>
...
@endif
    ...
    <script src="{{ asset('js/custom/custom-booknow-error.js') }}"></script>
