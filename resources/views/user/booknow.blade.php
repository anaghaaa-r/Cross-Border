<form class="tp-form-wrap bg-gray tp-form-wrap-one pl-0" method="POST" action="{{ route('booknow.submit') }}"
    id="bookingForm">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <h4 class="single-page-small-title">Book Now</h4>
        </div>

        <div class="col-md-3">
            <label class="single-input-wrap">
                <span class="single-input-title">Name</span>
                <input type="text" name="name" id="booknow-name">
            </label>
            <p id="booknow-name-required" style="display: none; color: brown;">Field is Required.</p>
        </div>
        <div class="col-md-3">
            <label class="single-input-wrap">
                <span class="single-input-title">Email</span>
                <input type="text" name="email" id="booknow-email">
            </label>
            <p id="booknow-email-error" style="display: none; color: brown;">Invalid Email.</p>
            <p id="booknow-email-required" style="display: none; color: brown;">Field is Required.</p>
        </div>
        <div class="col-lg-2">

            <label class="single-input-wrap">
                <span class="single-input-title">Area Code<br></span>

                <select name="countrycode" class="custom-select" style="height:50px;" id="booknow-countrycode">
        ...
        <div class="col-lg-4">
            <label class="single-input-wrap">
                <span class="single-input-title">Phone<br></span>
                <input type="text" name="phone" id="booknow-phone">
            </label>
            <p id="booknow-phone-error" style="display: none; color: brown;">Invalid Phone Number.</p>
            <p id="booknow-phone-required" style="display: none; color: brown;">Field is Required.</p>
        </div>

        <div class="col-lg-12">
            <label class="single-input-wrap">
                <span class="single-input-title">Message</span>
                <textarea name="message" id="booknow-message"></textarea>
            </label>
        </div>
        
        <div class="col-lg-12">
            <div class="single-input-wrap">
                <div id="booknow_captcha_element"></div>
            </div>
        </div>
        
        <input type="hidden" name="place" value="{{ $packages->place }}">

        <input type="hidden" name="package" value="{{ $packages->package }}">

        <div class="col-12">

            <button type="submit" class="btn btn-yellow float-right">Send</button>
        </div>
    </div>
</form>