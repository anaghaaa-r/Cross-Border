...
<body>
            ...
            <table class="table table-hover table-striped">
                <thead>
                    <tr>
                        ...
                        <td>Phone</td>
                        <td>Message</td>
                        <td>Service Needed / Selected Package</td>
                        <td>Actions</td>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($booking['serviceNeeded'])
                            {{ $booking['serviceNeeded'] }}
                            @else
                            @php
                            $selectedPackage = json_decode($booking['selectedPackage'], true);
                            @endphp
                            Place: {{ $selectedPackage['place'] }}<br>
                            Package: {{ $selectedPackage['package'] }}
                            @endif
                        </td>
                        <td class="text-center">

                            <a data-toggle="modal" data-target="#deleteModal" onclick="openDeleteModal({{ $booking['id'] }})">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h2 class="modal-title fs-5" id="deleteModalLabel">Delete Booking</h2>
                                        ...
                                        <div class="modal-body">
                                            <p>Delete booking with ID: <span id="bookingId"></span></p>
                                        </div>
    ...
    <!-- main js -->
    <script src="{{ asset('js/custom/custom-deletebooking.js') }}"></script>
