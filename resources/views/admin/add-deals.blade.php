...
<body>
    ...
    <main class="add-section">
        <section class="add-deals-section">
            <div class="container py-5">
                <h1>ADD DEALS PACKAGE</h1>
                <div class="deals-add-area">
                    <div class="row">
                        <div class="col-3"></div>
                        <div class="col-6">
                            <form method="POST" action="{{ route('deal.submit') }}" id="packageForm">
                                @csrf
                                <label>Place</label>
                            ...
                            <input type="text" class="form-control mb-3" [(ngModel)]="validity" name="validity" required> -->
                                ...
                                <button type="submit" class="btn btn-primary" value="Add Deals">
                                    ADD DEALS PACKAGE
                                </button>
        ...
        <section class="deals container">
            <div class="row">
                ...
                <div class="col-3 mb-5">
                    <div class="deal-card d-flex flex-column" style="height: 100%;">
                        <div class="card-body">
                            <a href="{{ url('update-deal', $deal['id']) }}" style="cursor: pointer;">
                        ...
                        <div class="d-flex flex-wrap flex-grow-1 align-content-end justify-content-center">
                            ...
                            <h4 style="width: 100%;" class="text-center">{{ $deal['package'] }}</h4>
                            <h6 style="width: 100%;" class="text-center">{{ $deal['price'] }}</h6>




                            <a class="btn btn-danger mt-3" data-toggle="modal" data-target="#deleteModal"
                                onclick="openDeleteModal({{ $deal['id'] }}, '{{ $deal['place'] }}')">
                                Delete Package
                            </a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h2 class="modal-title fs-5" id="deleteModalLabel">Delete Deal</h2>
                                        ...
                                        <div class="modal-body">
                                            <p>
                                                Delete package : <span id="dealId" style="display:none;"></span>
                                                <span id="dealPlace"></span>
                                            </p>
                                        </div>
    ...
    <script src="{{ asset('js/custom/custom-delete-deals.js') }}"></script>
