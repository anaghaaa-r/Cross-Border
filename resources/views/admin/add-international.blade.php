...
<body>
    ...
    <main class="add-section">
        <section class="add-international-section">
            <div class="container py-5">
                <h1>ADD INTERNATIONAL PACKAGE</h1>
                <div class="international-add-area">
                    <div class="row">
                        <div class="col-3"></div>
                        <div class="col-6">
                            <form method="POST" action="{{ route('international.submit') }}" id="packageForm">
                                @csrf
                                <label>Place</label>
        ...
        <section class="international container">
            <div class="row">
                @foreach ($allinternational as $international)
                <div class="col-3 mb-5">
                    <div class="international-card d-flex flex-column" style="height: 100%;">
                        <div class="card-body">
                            <a href="{{ url('update-international', $international['id']) }}" style="cursor: pointer;">
                                <img src="{{ asset('storage/' . $international['image']) }}" alt="International image"
                                    class="international-image">
                            </a>
                        </div>
                        <div class="d-flex flex-wrap flex-grow-1 align-content-end justify-content-center">
                            <h5 style="width: 100%;" class="text-center">
                                <a href="{{ url('update-international', $international['id']) }}" style="cursor: pointer;">
                                    <b>{{ $international['place'] }}</b>
                                </a>
                            </h5>
                            <h4 style="width: 100%;" class="text-center">{{ $international['package'] }}</h4>
                            <h6 style="width: 100%;" class="text-center">{{ $international['price'] }}</h6>




                            <a class="btn btn-danger mt-3" data-toggle="modal" data-target="#deleteModal"
                                onclick="openDeleteModal({{ $international['id'] }}, '{{ $international['place'] }}')">
                                Delete Package
                            </a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h2 class="modal-title fs-5" id="deleteModalLabel">Delete international</h2>
                                        ...
                                        <div class="modal-body">
                                            <p>
                                                Delete package : <span id="internationalId" style="display:none;"></span>
                                                <span id="internationalPlace"></span>
                                            </p>
                                        </div>
    ...
    <script src="{{ asset('js/custom/custom-delete-international.js') }}"></script>
